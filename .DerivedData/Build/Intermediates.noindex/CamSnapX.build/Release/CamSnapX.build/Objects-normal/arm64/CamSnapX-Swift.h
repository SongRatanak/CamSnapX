...
#ifndef CAMSNAPX_SWIFT_H
#define CAMSNAPX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CamSnapX",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC8CamSnapX25AllInOneOverlayController")
@interface AllInOneOverlayController : NSObject
...
@class NSCoder;
@class NSEvent;
SWIFT_CLASS("_TtC8CamSnapX20AnnotationCanvasView")
...
SWIFT_CLASS("_TtC8CamSnapX21CaptureAreaController")
@interface CaptureAreaController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSNotification;
SWIFT_CLASS("_TtC8CamSnapX29CaptureHistoryPanelController")
@interface CaptureHistoryPanelController : NSObject <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSWindow;
SWIFT_CLASS("_TtC8CamSnapX21ImageViewerController")
@interface ImageViewerController : NSObject <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
...
SWIFT_CLASS("_TtC8CamSnapX19KeyableOverlayPanel")
@interface KeyableOverlayPanel : NSPanel
...
SWIFT_CLASS("_TtC8CamSnapX11NonKeyPanel")
...
SWIFT_CLASS("_TtC8CamSnapX18OverlayContentView")
...
SWIFT_CLASS("_TtC8CamSnapX12PreviewPanel")
...
SWIFT_CLASS("_TtC8CamSnapX16ScreenSelectView")
@interface ScreenSelectView : NSView
@property (nonatomic, readonly, getter=isFlipped) BOOL flipped;
- (BOOL)acceptsFirstMouse:(NSEvent * _Nullable)event SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC8CamSnapX33ScrollingCaptureOverlayController")
@interface ScrollingCaptureOverlayController : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

/// A lightweight view that draws a red dashed border rectangle.
SWIFT_CLASS("_TtC8CamSnapX19SelectionBorderView")
@interface SelectionBorderView : NSView
- (void)drawRect:(NSRect)dirtyRect;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC8CamSnapX23SettingsPanelController")
...
SWIFT_CLASS("_TtC8CamSnapX12ToolbarPanel")
